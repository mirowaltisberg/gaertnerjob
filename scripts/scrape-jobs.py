"""
Scrape Swiss gardening/landscaping (Gärtner) jobs using python-jobspy and output JSON.
...
DEFAULT_SEARCH_TERMS = [
    ...
    "Pflasterer",
    "Baggerführer Gartenbau",
    "Maschinenführer Gartenbau",
    "Greenkeeper",
    "Friedhofgärtner",
    "Forstarbeiter",
    "Forstwart",
...
def normalize_job(raw: dict, idx: int) -> dict | None:
    ...
    stable_id = f"scraped-gaertner-{url_hash}"
        ...
        try:
            ...
            for job in existing:
                ...
                if url and url not in seen_urls:
                    ...
                    job["id"] = f"scraped-gaertner-{url_hash}"
