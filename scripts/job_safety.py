"""Shared deny-first Gartenbau classifier backed by src/config/job-safety.json."""
...
def classify_gaertner_title(title_value: Any) -> dict[str, Any]:
    ...
    if not match:
        return {"disposition": "REJECT", "reason": "no-gaertner-title-signal"}
    ...
    return {
        "disposition": "ACCEPT",
        "reason": "specific-gaertner-title" if specific else "broad-role-with-gaertner-context",
