...
import type { EditorialContent } from "@/data/editorial/gaertnerjob";
import { EDITORIAL_BYLINE } from "@/data/editorial/gaertnerjob";

interface EditorialIntroProps {
  /** Display label for the role, e.g. "Landschaftsgärtner EFZ" */
  role: string;
