...
export const metadata: Metadata = {
  ...
  description:
    "Gartenbaustellen nach ausgewählten Schweizer Städten und Regionen durchsuchen.",
  alternates: { canonical: "/gaertner-in-der-naehe" },
  openGraph: {
    title: "Gärtner in der Nähe | Jobs in deiner Stadt finden",
    description: "Gartenbaustellen nach ausgewählten Schweizer Städten und Regionen durchsuchen.",
    url: "/gaertner-in-der-naehe",
    type: "website",
  },
  twitter: {
